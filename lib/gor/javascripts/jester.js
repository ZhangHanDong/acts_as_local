...
//	);
  ...
  _loadCollection : function(doc) {
    ...
    if (this._format == "json") {
      ...
      collection = doc[this._plural_xml][this._singular_xml][0].map( bind(this, function(elem) {
...
Object.extend(Jester.Resource.prototype, {
  ...
  save : function(callback) {
    var saveWork = bind(this, function(transport) {
      ...
      // This is to avoid ActiveRecord dumping nil values as <footype="nil">
      // and Jester's inability to parse the nil value
      else if (elements[attr] && elements[attr]["@nil"]) {
        if (elements[attr]["@nil"] == "true") // make sure nil isreturning true
